      ...
      <template v-else>
          ...
          <div v-for="col in columns" :key="col.status" class="kanban-col">
            ...
            <div class="kanban-col-body">
              ...
              <div v-for="order in filteredByStatus(col.status)" :key="order.id" class="kanban-card">
                ...
                <div class="kanban-card-pickup" style="display:flex;align-items:center;gap:0.3rem">
                  <Clock :size="12" /> {{ order.pickupAt }}
                </div>
        ...
        <template v-if="activeView==='history'">
          <div style="display:flex;justify-content:space-between;align-items:center;margin:1.5rem 0 0.75rem">
            ...
            <button class="btn btn-ghost btn-sm" style="display:flex;align-items:center;gap:0.3rem" @click="exportCSV">
            ...
            <table class="data-table">
              ...
              <tbody>
                ...
                <tr v-for="order in allOrders" :key="order.id">
                  ...
                  <td style="font-size:0.8rem;display:flex;align-items:center;gap:0.3rem"><Clock :size="12" /> {{ order.pickupAt }}</td>
...
import { Bell, User, Clock, Check, Search, ArrowUpRight, LayoutGrid, ClipboardList, UtensilsCrossed } from 'lucide-vue-next'
